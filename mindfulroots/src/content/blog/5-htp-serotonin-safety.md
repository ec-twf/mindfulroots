...
If low mood, anxiety or sleep problems are pushing you toward a supplement like this, that is a meaningful signal in itself — and a better next step than self-experimentation is a conversation with a clinician who can look at the whole picture, including interactions, and help you weigh the options safely. Our [crisis and professional support resources](/get-help/) page lists free and confidential places to start. None of the information here is medical advice; please also read our [medical disclaimer](/disclaimer/).

## Frequently asked questions

**Does 5-HTP work for depression?**
The honest answer is that the evidence is limited and inconclusive. A 2002 Cochrane review found a signal of benefit but judged the trials too few and too low in quality to recommend 5-HTP, advising conventional treatments instead. We rate its mood evidence as *emerging*.
...
There is no reliable answer, partly because the evidence for a mood effect is weak to begin with. Its short half-life means any effect would not be long-lasting through the day, which is why studied regimens used divided doses.
